...
// numero de caras que queramos que tenga el dado que deberá silumar el codigo dentro de la función. 
...
function rollDice(value){
    ...
    const resultado = Math.ceil(Number*value);
    return resultado;
}
const tanda = rollDice(212);
console.log(tanda);